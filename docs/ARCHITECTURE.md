...
- **Marketing asset specs** (`templates/`) - business card content specs, pricing sheet templates, scripts (review-request wording, etc.). These are *templates and copy*, not filled-in customer-specific content.
...
- **Setmore Free** (launch) - service-based booking. Customers request/book through Setmore's own hosted booking page, linked from the site and from business card QR codes.
...
| Business card copy/layout | This repo (`app/first-20-card.html`) |
