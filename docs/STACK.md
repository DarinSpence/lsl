...
**What it does:** Design tool for door hangers and social graphics.
...
**Cost:** Free tier is generally sufficient for door hangers and simple social graphics. **TODO: verify current Canva Free export/template limits at implementation time** — Canva's free-vs-Pro feature boundary shifts periodically and wasn't re-verified this pass.

## QR code generator

**What it does:** Turns the request-service/booking link into a scannable code for door hangers.
**Why needed:** Fastest path from a physical door hanger to a phone booking a job.
**Needed now:** Phase D.
...
**What it does:** Helps draft door hanger copy, website wording, review requests, explain spreadsheet formulas, and teach business concepts.
